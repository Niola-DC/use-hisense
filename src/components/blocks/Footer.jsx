...
const Footer = () => {
  return (
    <div className="bg-primary px-6 py-8 lg:py-12 md:px-10">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-6 lg:space-y-0">
        {/* Logo */}
